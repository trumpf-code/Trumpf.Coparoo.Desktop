...
namespace Trumpf.Coparoo.Desktop.Tests.Framework
{
    ...
    public class PageObjectLocatorStatic
    {
        ...
        private class D<T> : ViewPageObject<object>, IChildOf<A>
        {
        }

        private class E<T> : ViewPageObject<object>, IChildOf<D<T>>
        {
        }

        private class F<T, TT> : ViewPageObject<object>, IChildOf<D<T>>
        {
        }

        private class G : ViewPageObject<object>, IChildOf<A>, IChildOf<B>
        {
        }
