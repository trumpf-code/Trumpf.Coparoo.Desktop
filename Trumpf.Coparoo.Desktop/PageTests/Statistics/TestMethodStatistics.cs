...
namespace Trumpf.Coparoo.Desktop.PageTests.Statistics
{
    ...
    internal class TestMethodStatistics
    {
        ...
        /// </summary>
        internal IEnumerable<TestMethodStatistic> Values => testMethodStats;
        ...
        {
            get { return testMethodStats.Any(t => !t.SuccessHasValue ? false : !t.Success); }
        }

        /// <summary>
        /// Gets a value indicating whether a test was not implemented.
        /// </summary>
        public bool AnyUnimplemented
        {
            get { return testMethodStats.Any(t => !t.SuccessHasValue); }
        }
        ...
        /// <returns>The extended test method statistics.</returns>
        public static TestMethodStatistics operator +(TestMethodStatistics c1, TestMethodStatistics c2)
        {
            return new TestMethodStatistics(c1.MethodInfo) { testMethodStats = c1.testMethodStats.Concat(c2.testMethodStats).ToList() };
        }
