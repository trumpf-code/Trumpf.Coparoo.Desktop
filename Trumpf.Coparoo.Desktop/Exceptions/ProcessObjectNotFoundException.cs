...
namespace Trumpf.Coparoo.Desktop.Exceptions
{
    ...
    public class ProcessObjectNotFoundException<TProcessObject> : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessObjectNotFoundException{TProcessObject}"/> class.
        /// </summary>
        public ProcessObjectNotFoundException()
