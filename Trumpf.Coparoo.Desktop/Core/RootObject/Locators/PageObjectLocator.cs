...
namespace Trumpf.Coparoo.Desktop.Core
{
    ...
    internal class PageObjectLocator : IPageObjectLocator
    {
        ...
        /// </summary>
        public int CacheTypeCount
        {
            get { return typeToPageObjectMap.Count; }
        }
        ...
        {
            get { return typeToPageObjectMap.Sum(e => e.Value.Count); }
        }
        ...
        public void Clear()
        {
            typeToPageObjectMap = new Dictionary<Type, HashSet<IPageObject>>();
        }
        ...
        {
            HashSet<IPageObject> o;
            if (typeToPageObjectMap.TryGetValue(typeof(TPageObject), out o))
            {
        ...
        private class IPageObjectEqualityComparer : IEqualityComparer<IPageObject>
        {
            ...
            public int GetHashCode(IPageObject obj)
            {
